...
import com.momo.app.data.proxy.M3u8Segment
import com.momo.app.data.proxy.parseM3u8
...
object DownloadManager {
    ...
    fun getDownloadDir(): File =
        File(appContext.getExternalFilesDir(Environment.DIRECTORY_MOVIES), "momo")
